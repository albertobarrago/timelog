...
| [03-flows.md](03-flows.md) | Tracking, Pomodoro, Notifications, Live Activity, Widgets |
...
| Widget | WidgetKit — iOS (Home Screen, Lock Screen, StandBy) + macOS (desktop, Notification Center) |
